return {

  {
    ...
    dependencies = {
      {
        -- Package manager for external (non-nvim) plugins, i.e. LSP, DAP, linters, formatters
      ...
      {
        -- UI for LSP status updates
        "j-hui/fidget.nvim",
        opts = {}
      },
      {
        -- Additional configuration for editing nvim lua files
        "folke/neodev.nvim",
      },
    },
    config = function()
      ...
      -- function to set up LSP-related keymaps when an LSP connects to a buffer
